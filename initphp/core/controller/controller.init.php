...
class controllerInit extends filterInit{
	 ...
	 *  @param  int     $istop 如果是后台就跳转到最顶端窗口 //lxz 2014.10.5
	 *  @return 
	 */
	public function redirect($url, $time = 0, $istop=0) {
		if ($istop)
		{
			exit('<script type="text/javascript">top.window.location.href="'.$url.'";</script>');
		}
		if (!headers_sent()) {
